...
| [Dakera](https://github.com/dakera-ai/dakera-deploy) | Persistent memory layer for AI agents: hybrid BM25 + vector retrieval, temporal reasoning, and LangChain/LlamaIndex integrations for production RAG. | [![Stars](https://img.shields.io/github/stars/dakera-ai/dakera-deploy?style=flat)](https://github.com/dakera-ai/dakera-deploy/stargazers) |
