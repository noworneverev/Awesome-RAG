...
| [Kiln](https://github.com/Kiln-AI/Kiln)                        | Build a RAG in minutes via drag-and-drop; free production-ready AI builder with RAG pipelines, evaluations, agents, MCP tool-calling, synthetic data, and fine-tuning.        | [![Stars](https://img.shields.io/github/stars/Kiln-AI/Kiln?style=flat)](https://github.com/Kiln-AI/Kiln/stargazers) |
